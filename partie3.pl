...
/*evolue: ajouter une assertion de concept a une liste LX, sa version mise a jour est LX1*/
...
transformation_and(Lie, Lpt, [(I, and(C1, C2))|Li_suite], Lu, Ls, Abr) :- 
                                                                        /*ajouter I:C1 et I:C2 a Li_suite, le resultat est dans Li1
...
complete_some([(I, some(R,C)|Lie_suite)], Lpt,Li,Lu,Ls,Abr) :- genere(I2), 
                                                                /*ajouter l'instance precedement cree a Lie_suite de sorte a ce que Lie1 contiene I2:C, 
...
deduction_all(Lie, [(I, all(R, C))|Lpt_suite], Li, Lu, Ls, Abr) :- setof((I2,C), member((I,I2,R) Abr), L),
                                                                    ...
                                                                    affiche_evolution_Abox(Ls, Lie, [(I, all(R, C))|Lpt_suite], Li, Lu, Abr, Ls1, Lie1, Lpt1, Li1, Lu1, Abr1),
